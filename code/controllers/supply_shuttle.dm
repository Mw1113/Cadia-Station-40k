...
/obj/machinery/computer/supplycomp
	name = "munitorium requisitions console"
...
/obj/machinery/computer/supplycomp/attack_hand(var/mob/user as mob)
	...
	if (temp)
		...
		<HR>\n<B>Munitorum messages</B><BR> [supply_shuttle.centcom_message ? supply_shuttle.centcom_message : "The Emperor Provides..."]"}
...
/obj/machinery/computer/supplycomp/attackby(I as obj, user as mob)
	if(istype(I,/obj/item/weapon/USBinterface) && !hacked)
